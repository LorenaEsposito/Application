...
public class NoteAdministrationImpl extends RemoteServiceServlet implements
		NoteAdministration {
	...
	/**
	 * Aktualisiert die Attribute eines Users in der Datenbank. Dazu ruft sie
	 * mit dem uebergebenen User den UserMapper auf, der dieses dann ueber eine
	 * UPDATE-Abfrage in der Datenbank aktualisiert.
	 * 
	 * @author Lorena Esposito
	 * @param u
	 ...
	 * ruft dazu, alle notwendigen Mapper (Notebook, Note, Permission) mit dem
	 * uebergebenen User auf, um ein vollstaendiges Loeschen aller Userdaten
	 * sicherzustellen.
	 * 
	 * @author Lorena Esposito
	 * @param u
	...
	/**
	 * Aktualisiert die Attribute eines Notebooks in der Datenbank. Dazu ruft
	 * sie mit dem uebergebenen Notebook den NotebookMapper auf, der dieses dann
	 * ueber eine UPDATE-Abfrage in der Datenbank aktualisiert.
	 * 
	 * @author Lorena Esposito
	 * @param nb
	...
	/**
	 * Loescht das uebergebene Notebook endgueltig aus der Datenbank. Die
	 * Methode ruft dazu, alle notwendigen Mapper (Note, Permission) mit dem
	 * uebergebenen Notebook auf, um ein vollstaendiges Loeschen aller
	 * Notebookdaten sicherzustellen.
	 * 
	 * @author Lorena Esposito
	 * @param nb
	...
	/**
	 * Aktualisiert die Attribute einer Note in der Datenbank. Dazu ruft sie mit
	 * der uebergebenen Note den NoteMapper auf, der diese dann ueber eine
	 * UPDATE-Abfrage in der Datenbank aktualisiert.
	 * 
	 * @author Lorena Esposito
	 * @param n
	 ...
	 * ruft dazu, alle notwendigen Mapper (Permission) mit der uebergebenen Note
	 * auf, um ein vollstaendiges Loeschen aller Notedaten sicherzustellen.
	 * 
	 * @author Lorena Esposito
	 * @param n
	 ...
	 * uebergebenen Permission den PermissionMapper auf, der diese dann ueber
	 * eine INSERT-Abfrage in die Datenbank einfuegt.
	 * 
	 * @author Lorena Esposito
	 * @param p
	...
	/**
	 * Aktualisiert die Attribute einer Permission in der Datenbank. Dazu ruft
	 * sie mit der uebergebenen Permission den PermissionMapper auf, der dieses
	 * dann ueber eine UPDATE-Abfrage in der Datenbank aktualisiert.
	 * 
	 * @author Lorena Esposito
	 * @param p
	...
	/**
	 * Aktualisiert die Attribute eines Duedates in der Datenbank. Dazu ruft sie
	 * mit dem uebergebenen Duedate den DuedateMapper auf, der dieses dann ueber
	 * eine UPDATE-Abfrage in der Datenbank aktualisiert.
	 * 
	 * @author Lorena Esposito
	 * @param dd
	 ...
	 * Dazu wird der UserMapper aufgerufen, der eine Methode beinhaltet mit der
	 * in der Datenbank nach dem gesuchten Namen gesucht wird. In der Methode
	 * wird eine ArrayList erstellt, die mit den Suchergebnissen befuellt wird.
	 * 
	 * @author Lorena Esposito
	 * @param userName
	 * @return users
	...
	/**
	 * Es kann nach einem bestimmten Notebook anhand seines Titels gesucht
	 * werden. Dazu wird der NotebookMapper aufgerufen, der eine Methode
	 * beinhaltet mit der in der Datenbank nach einem bestimmten Titel gesucht
	 * wird. In der Methode wird eine ArrayList erstellt, die mit den
	 * Suchergebnissen befuellt wird.
	 * 
	 * @author Lorena Esposito
	 * @param title
	 * @return notebooks
	 ...
	 * in der Datenbank nach einem bestimmten Titel gesucht wird. In der Methode
	 * wird eine ArrayList erstellt, die mit den Suchergebnissen befuellt wird.
	 * 
	 * @author Lorena Esposito
	 * @param title
	...
	/**
	 * Es kann nach einer bestimmten Note anhand ihres Faelligkeitsdatums
	 * gesucht werden. Dazu wird der NoteMapper aufgerufen, der eine Methode
	 * beinhaltet mit der in der Datenbank nach einem bestimmten
	 * Faelligkeitsdatum gesucht wird. In der Methode wird eine ArrayList
	 * erstellt, die mit den Suchergebnissen befuellt wird.
	 * 
	 * <<<<<<< HEAD
	 * 
	 * @author Lorena Esposito
	 * @param duedate
	 * @return notes =======
	 * @author Lorena Esposito <<<<<<< HEAD
	 * @param duedate
	 * @return notes ======= <<<<<<< HEAD <<<<<<< HEAD
	 * @param duedate
	 *            <<<<<<< HEAD
	 * @return notes
	 * @throws IllegalArgumentException
	 *             =======
	 * @return notes >>>>>>> refs/heads/master =======
	 * @param duedate
	 * @return notes >>>>>>> refs/remotes/origin/master =======
	 * @param duedate
	 * @return notes >>>>>>> refs/heads/master >>>>>>> refs/heads/Lola
	 * @throws IllegalArgumentException
	 *             >>>>>>> refs/heads/Lola
	 */
	 ...
	 * Permission.
	 */
	public ArrayList<Notebook> getNotebooksOfUser(AppUser u)
			throws IllegalArgumentException {
	...
	/**
	 * Diese Methode gibt alle Notizen eines Notizbuchs in einer ArrayList
	 * zurueck.
	 * 
	 * @param nbTitle
